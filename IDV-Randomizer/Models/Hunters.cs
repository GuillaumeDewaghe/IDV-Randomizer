...
namespace IDV_Randomizer.Models
{
    ...
    {
        public static Hunter HellEmber { get; } = new Hunter(AppResources.HellEmberName, AppResources.HellEmberImage);
        ...
        public static Hunter MadEyes { get; } = new Hunter(AppResources.MadEyesName, AppResources.MadEyesImage);
        public static Hunter Feaster { get; } = new Hunter(AppResources.FeasterName, AppResources.FeasterImage);
        public static Hunter DreamWitch { get; } = new Hunter(AppResources.DreamWitchName, AppResources.DreamWitchImage);
        public static Hunter AxeBoy { get; } = new Hunter(AppResources.AxeBoyName, AppResources.AxeBoyImage);
        public static Hunter EvilReptilian { get; } = new Hunter(AppResources.EvilReptilianName, AppResources.EvilReptilianImage);
        public static Hunter BloodyQueen { get; } = new Hunter(AppResources.BloodyQueenName, AppResources.BloodyQueenImage);
        public static Hunter Guard26 { get; } = new Hunter(AppResources.Guard26Name, AppResources.Guard26Image);
        public static Hunter Disciple { get; } = new Hunter(AppResources.DiscipleName, AppResources.DiscipleImage);
        public static Hunter Violonist { get; } = new Hunter(AppResources.ViolonistName, AppResources.ViolonistImage);
        ...
        public static Hunter Hermit { get; } = new Hunter(AppResources.HermitName, AppResources.HermitImage);
        public static Hunter NightWatch { get; } = new Hunter(AppResources.NightWatchName, AppResources.NightWatchImage);
    }
}